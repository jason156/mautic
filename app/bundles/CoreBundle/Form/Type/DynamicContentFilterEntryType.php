...
class DynamicContentFilterEntryType extends AbstractType
{
    ...
    private function filterFieldChoices()
    {
        $this->fieldChoices['lead'] = array_filter($this->fieldChoices['lead'], function ($key) {
            return !in_array($key, ['company', 'leadlist', 'campaign', 'device_type', 'device_brand', 'device_os', 'lead_email_received', 'tags', 'dnc_bounced', 'dnc_unsubscribed', 'dnc_unsubscribed_manually', 'dnc_bounced_sms', 'dnc_unsubscribed_sms', 'dnc_unsubscribed_sms_manually', 'hit_url']);
